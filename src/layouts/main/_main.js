        ...
        <div class="mx-auto max-w-2xl py-16 sm:py-24 lg:py-32">
          <div class="hidden sm:mb-8 sm:flex sm:justify-center">
            <div class="relative rounded-full py-1 px-3 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              <Link to={"/"} class="font-semibold text-indigo-600">
                <span class="absolute inset-0" aria-hidden="true"></span>Join us{" "}
          ...
          <div class="text-center">
            ...
            <p class="mt-6 text-lg leading-8 text-gray-600">
              We are the group of engineers, who cares about your optimal
              expense and lead you business online.
            </p>
